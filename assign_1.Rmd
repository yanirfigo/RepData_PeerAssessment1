...
```{r plot compering weekendsan weekdays}
...
plot4<-ggplot(agg_weekdays)+geom_line(aes(interval,avg_steps_per_interval),lwd=1.1,color="blue")
plot4<-plot4 + scale_y_continuous(limits=c(0, 220))
plot5<-ggplot(agg_weekEnds)+geom_line(aes(interval,avg_steps_per_interval),lwd=1.1,color="blue")
